...
await call('setWebhook',{url:new URL('/telegram/webhook',APP_ORIGIN).href,secret_token:TELEGRAM_WEBHOOK_SECRET,allowed_updates:['message','callback_query','my_chat_member'],drop_pending_updates:false});
